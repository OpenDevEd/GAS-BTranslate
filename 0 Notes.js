...
History.
Split from BUtils3 on 2021-05-10
...
Select source
Select the source language. Note that this only provides a hint to the translator. Scroll down and select Next.

Select target
Select the target language(s). Scroll down and select Next.
